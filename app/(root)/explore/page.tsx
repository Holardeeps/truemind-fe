      ...
      <section className="container mx-auto bg-white rounded-t-lg space-y-3.5 mt-18 py-4.5 max-w-338.5">
        ...
        <ul className="">
          {menuCategories.map((menu) => (
            <li
              className={`font-medium text-[24px] leading-8.5 text-[#000000] pl-6.5 py-1 capitalize ${menu === "popular" && "border-l-4 border-primary-orange bg-light-orange"} cursor-pointer`}
              key={menu[0]}
            >
